...
public class Jade extends Piece {
	...
	private final List<PieceType> harmonicPieces = Arrays.asList(PieceType.LILY, PieceType.ROSE, PieceType.LOTUS);
	private final List<PieceType> disharmonicPieces = Arrays.asList(PieceType.RHODODENDRON, PieceType.ORCHID);
	public boolean isInHarmony;
	public Jade(final int piecePosition, final Alliance pieceAlliance) {
		super(PieceType.JADE, piecePosition, pieceAlliance, true);
		// TODO Auto-generated constructor stub
	}

	public Jade(final Alliance pieceAlliance,
						 final int piecePosition,
						 final boolean isFirstMove) {
		super(PieceType.JADE, piecePosition, pieceAlliance, isFirstMove);
	}
	...
	@Override
	public Jade movePiece(final Move move) {
		return new Jade(move.getDestinationCoordinate(), move.getMovedPiece().getPieceAlliance());
	}
	...
	public String toString() {
		return PieceType.JADE.toString();
	}
}
