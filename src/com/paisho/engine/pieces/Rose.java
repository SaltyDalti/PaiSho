...
public class Rose extends Piece {
	...
	private final List<PieceType> harmonicPieces = Arrays.asList(PieceType.JADE, PieceType.CHRYSANTHEMUM, PieceType.LOTUS);
	private final List<PieceType> disharmonicPieces = Arrays.asList(PieceType.JASMINE, PieceType.ORCHID);
	public boolean isInHarmony;

	public Rose(final int piecePosition, final Alliance pieceAlliance) {
		super(PieceType.ROSE, piecePosition, pieceAlliance, true);
	}

	public Rose(final Alliance pieceAlliance,
						final int piecePosition,
						final boolean isFirstMove) {
		super(PieceType.ROSE, piecePosition, pieceAlliance, isFirstMove);
	}
	...
	@Override
	public Rose movePiece(final Move move) {
		return new Rose(move.getDestinationCoordinate(), move.getMovedPiece().getPieceAlliance());
	}
	...
	public String toString() {
		return PieceType.ROSE.toString();
	}
}
