...
public class Board {
	...
	private Board(final Builder builder) {
		...
		this.hostPlayer = new HostPlayer(this, hostStandardLegalMoves, opponentStandardLegalMoves);
		this.opponentPlayer = new OpponentPlayer(this, hostStandardLegalMoves, opponentStandardLegalMoves);
	...
	public static Board createStandardBoard() {
		...
		builder.setPiece(new Jasmine(193, Alliance.HOST));
		builder.setPiece(new Rose(215, Alliance.OPPONENT));
